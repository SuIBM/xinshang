<template>
        			<div id="segmentedControlContents" class="mui-col-xs-9" style="border-left: 1px solid #c8c7cc; mui-active">
                        <div id="content1" class="mui-control-content" :visible.sync="sheetVisible">
